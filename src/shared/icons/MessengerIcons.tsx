...
export function VkIcon({ className, ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="currentColor"
...
const MESSENGER_ICON_MAP = {
  vk: VkIcon,
  telegram: TelegramIcon,
} as const;

export function getMessengerIcon(id: keyof typeof MESSENGER_ICON_MAP) {
  return MESSENGER_ICON_MAP[id];
}
